...
from google import Translator , LANGUAGES
...
filename = PhotoImage(file = "crystal2.png")
...
#heading
Label(root, text = "LANGUAGE TRANSLATOR", font = "arial 20 bold", bg="#ff69b4").pack()
...
##########  Translate Button ########
trans_btn = Button(root, text = 'Translate',font = 'arial 12 bold',bd=5,pady = 5,command = Translate , bg = 'royal blue1', activebackground = 'sky blue')
